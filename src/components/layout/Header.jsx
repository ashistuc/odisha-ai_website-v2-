                  ...
                  <li key={index}>
                    {item.type === 'link' ? (
                      <Link
                        ...
                        className={`inline-flex items-center justify-center text-white font-medium text-sm rounded-md transition-all duration-200 whitespace-nowrap ${
                          index === 0
                            ? 'w-8 h-8 hover:bg-white/20'
                            : `px-3 py-1.5 ${index !== 0 && location.pathname === item.href ? 'bg-white/30' : 'hover:bg-white/20'}`
                          }`}
                      >
                        {item.name}
                      </Link>
                      ...
                      <button
                        ...
                        aria-label={item.ariaLabel || item.name}
                        className="inline-flex items-center justify-center px-3 py-1.5 text-white font-medium text-sm hover:bg-white/20 rounded-md transition-all duration-200 whitespace-nowrap"
                      >
                        {item.name}
                      </button>
                    )}
